    ...
    <div>
      <div className="w-11/12 lg:w-9/12 mx-auto bg-blue-50 text-gray-800 rounded-md shadow-md overflow-hidden h-auto pb-8 mt-6 ">
        <div className="flex items-center justify-between">
          ...
          <Link onClick={goBack} className="text-white bg-red-500 hover:bg-red-600 rounded-md mr-4">
            <MdClose size={26}/>
          </Link>
        </div>
        <div className="flex items-center justify-start gap-6 p-6">
          <figure className="overflow-hidden rounded-md shadow-md">
            <img src={carPhoto} alt="car photo" className="w-60 lg:w-80" />
          </figure>
        ...
        <div>
          <div className="w-11/12 mx-auto hidden  lg:flex gap-4">
            <p className="text-md font-semibold">
              <span className="font-bold text-sm lg:text-md mr-2">
                Location:
              </span>
              {carLocation}
            </p>
            ...
            <p className="text-md font-semibold">
              ...
              {bookingStatus > 0 ? "Booked" : "Not Booked"}
            </p>
            <button
              onClick={handleShowModal}
              className="bg-blue-300 text-md font-semibold hover:bg-blue-400 text-white hover:text-white px-3 py-1 rounded-md"
            >
              Book Now
            </button>
          </div>
          ...
          <div className="w-11/12 mx-auto block lg:hidden">
            <table className="w-full">
              <tr>
                ...
                <td className="font-bold text-sm lg:text-md mr-2">
                  Included On:
                </td>
              ...
              <tr>
                ...
                <td colspan="2" className="pr-4">
                  <button
                    onClick={handleShowModal}
                    className="w-full bg-blue-300 text-md font-semibold hover:bg-blue-400 text-white hover:text-white py-1 rounded-md"
                  >
                    Book Now
                  </button>
                </td>
        ...
        <div className="w-11/12 mx-auto">{carDescription}</div>
      </div>
      <div>
        {showModal && (
          <BookingWindow carInfo={carInfo} modalClose={setShowModal} />
        )}
      </div>
    </div>
  );
