...
const CarGridCard = ({ car }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-105">
            <img src={car.carPhoto} alt={car.carModel} className="w-full h-48 object-cover border-b border-gray-200" />
            <div className="p-4">
                ...
                <Link 
                    ...
                    className="mt-4 inline-block w-full bg-blue-400 text-white py-2 px-4 rounded-md text-center hover:bg-blue-500 transition-colors duration-200"
                >
                    Book Now
                </Link>
            </div>
