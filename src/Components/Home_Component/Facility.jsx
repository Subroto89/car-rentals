     ...
     <div>
        <h2 className="text-3xl font-bold text-center my-8">Why Choose Us?</h2>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-8 ">
            {
                facilitiesData.map((facility, index) => <div key={index} className="w-full p-6 bg-white hover:bg-yellow hover:opacity-50 shadow-lg rounded-lg flex flex-col items-center text-center">
